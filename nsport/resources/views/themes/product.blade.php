...
<div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-9 col-sm-9">
         <div id="content">
          @foreach($categoty_temp as $value) 
            <div class="title-home-product"><h1>{{ $value->name }}</h1></div>
            <div class="section">
          <div class="sub" >
          <div class="row"> 
          <div class="col-sm-12"> 
          <?php  $product_temp  = DB::table('products')->where('category_id',$value->id)->where('published','yes')->get(); ?>
